...
* VERSION 2.6.3f  Sun Jun  2 17:39:38 1996  Doug Lea  (dl at gee)
...
* Vital statistics:
  ...
  Assumed pointer representation:       4 bytes (or 8 bytes)
...
* Limitations
    ...
    * No support for 64-bit pointers.
...
/*
  ...
  Realloc algorithm:
    ...
    unless HAVE_MREMAP is defined, in wchi case mrep is used.
...
#endif
{
  ...
  if (p == oldtop && csz > oldtopsize) 
  {
    ...
    MALLOC_ZERO(mem, oldtopsize - SIZE_SZ);
    return mem;
  }
#endif
...
History:
    ...
    V2.6.3 Sun May 19 08:17:58 1996  Doug Lea  (dl at gee)
      * Malloc, calloc: add optimizations from Raymond Nijssen
